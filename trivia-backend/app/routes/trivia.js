 ...
 *     curl -i https://api.nike-workshop.com/api/trivia/all
 */
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i https://api.nike-workshop.com/api/trivia/question/1
 */
 ...
 *          -d "{'answer' : 'Broomball'}" \
 *          -X POST https://api.nike-workshop.com/api/trivia/question/1
 */
